...
public class FruitLoop {
  ...
  public FruitLoop(Color color, Color bgColor, GridCell gridCell,
    ...
    double cellYCenter = (gridCell.getY() +
                          PA8Constants.GRID_CELL_SIZE / HALF_DIVISOR);
    double outerLoopOffset = (PA8Constants.GRID_CELL_SIZE /
                              PA8Constants.OUTER_SIZE_DIVISOR / HALF_DIVISOR);
    double innerLoopOffset = (PA8Constants.GRID_CELL_SIZE /
          PA8Constants.INNER_SIZE_DIVISOR / HALF_DIVISOR);
    ...
    outer = new FilledOval(
      ...
      PA8Constants.GRID_CELL_SIZE / PA8Constants.OUTER_SIZE_DIVISOR, canvas);
    
    inner = new FilledOval(
      cellXCenter - innerLoopOffset, cellYCenter - innerLoopOffset,
      PA8Constants.GRID_CELL_SIZE / PA8Constants.INNER_SIZE_DIVISOR,
      PA8Constants.GRID_CELL_SIZE / PA8Constants.INNER_SIZE_DIVISOR, canvas);
